        ...
        if self.popup:
            ...
            self.bg = Button(
                ...
                on_click='''
                    ...
                    self.world_parent = camera.ui
                    self.fade_out(duration=.1)
                    self.parent.animate_scale_y(0, duration=.1)
                    invoke(setattr, self, 'world_parent', original_parent, delay=.19)
                    invoke(setattr, self.parent, 'enabled', False, delay=.2)
                    '''
                )
