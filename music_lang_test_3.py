...
rand = NoteSection(random_melody.upper(), octave=0, speed=1, loops=4, chord_delays=1/32, volume=.8, sus=1, attack=.05)
rand = NoteSection(random_melody.upper(), octave=1, speed=1, loops=4, chord_delays=1/32, volume=.2, sus=1, attack=.1, offset=2)
#
rand = NoteSection('lwwlwwkqqkqq'.upper(), octave=0, speed=2, loops=4, chord_delays=1/32, volume=.125, sus=.5, attack=.1, delay=.5)
...
rand = NoteSection('YRTE-RWEQ', octave=-1, speed=1, loops=4, chord_shape=(0,2,4,7,9,11,9,7,5,3,1,3,5,7,6,2), chord_delays=1/16, volume=.1, sus=1, attack=.1, instrument='alternating_piano')
